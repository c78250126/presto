...
export default function ImgDialog ({ token, data, deckNum, slideIndex, imgModal, setImgModal }) {
  ...
  const handleSubmit = (event) => {
    ...
    if (image) {
      sendValues.src = image;
    } else {
      sendValues.src = values.src;
    }
    sendValues.alt = values.alt;
      ...
      >
        <DialogContent sx={{ paddingTop: 1, paddingBottom: 1 }}>
          ...
          <DialogContentText sx={{ marginTop: '20px' }}>
            ...
            <DialogContentText sx={{ marginTop: '20px' }}>
              Please enter the name of your image:
            </DialogContentText>
